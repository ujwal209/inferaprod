    ...
    <footer className="bg-white dark:bg-[#050505] py-12 sm:py-16 border-t border-zinc-200/50 dark:border-zinc-800/50 font-outfit">
      <div className="max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-12 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div className="flex flex-col sm:flex-row gap-10 sm:gap-16">
          ...
          <div className="flex flex-col gap-3">
            <h4 className="font-google-sans text-[13px] font-bold text-zinc-900 dark:text-white uppercase tracking-wider mb-1">Socials</h4>
            <div className="flex items-center gap-5 mt-1">
              <a href="https://x.com/inferacore_tech" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors hover:-translate-y-0.5 transform duration-200">
                <Twitter size={18} />
              </a>
              <a href="https://www.linkedin.com/in/inferacore" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors hover:-translate-y-0.5 transform duration-200">
                <Linkedin size={18} />
              </a>
              <a href="https://www.instagram.com/inferacore?igsh=MTB1ZnFiM2Nob2ZiYQ==" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors hover:-translate-y-0.5 transform duration-200">
                <Instagram size={18} />
              </a>
              <a href="https://www.facebook.com/share/18tZkRvT3X/" target="_blank" rel="noopener noreferrer" className="text-zinc-400 hover:text-blue-600 dark:hover:text-blue-400 transition-colors hover:-translate-y-0.5 transform duration-200">
                <Facebook size={18} />
              </a>
            </div>
          </div>
